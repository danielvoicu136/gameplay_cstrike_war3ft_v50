	...
	*/
	...
	if ( iRaceID )
	{
		...
		switch ( iRaceID )
		{
			...
			case 9: r=255,	g=255,	b=0;		// Draenei 
			case 10: r=255,	g=0,	b=0;		// Worgen
			case 11: r=0,	g=255,	b=0;		// Blood Elves
			case 12: r=137,	g=137,	b=137;		// Troll
			case 13: r=0,	g=0,	b=255;		// Warlock
			case 14: r=75,	g=0,	b=130;		// Priest
			case 15: r=137,	g=137,	b=137;		// Death Knight
			case 16: r=0,	g=255,	b=0;		// Druid
		...
		switch ( flag )
		{
			case ICON_FLASH:
			{
				...
				if ( SM_GetSkillLevel( id, ULTIMATE_CLAWS ) > 0 )
				{
					r=255, g=255, b=255;
				}
			}
...
ULT_RemoveCharge( id, iFuncID )
{
	...
	ChatColor( id,"!g* [!t %s!g ] You have blocked an enemy's ultimate !", g_MODclient );
