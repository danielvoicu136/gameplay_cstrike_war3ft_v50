SM_Init()
{
	...
	g_SkillOwner[SKILL_SHADOW				]	= RACE_DRAENEI;
	g_SkillOwner[SKILL_HEROIC		]	= RACE_DRAENEI;
	g_SkillOwner[SKILL_ABUNDENCE		]	= RACE_DRAENEI;
	g_SkillOwner[ULTIMATE_GIFT		]	= RACE_DRAENEI;

	
	g_SkillOwner[SKILL_RUN				]	= RACE_WORGEN;
	g_SkillOwner[SKILL_ABERRATION		]	= RACE_WORGEN;
	g_SkillOwner[SKILL_FORM		]	= RACE_WORGEN;
	g_SkillOwner[ULTIMATE_CLAWS		]	= RACE_WORGEN;

	g_SkillOwner[SKILL_TORENT				]	= RACE_BLOODELF;
	g_SkillOwner[SKILL_AFFINITY		]	= RACE_BLOODELF;
	g_SkillOwner[SKILL_BLOODEYES		]	= RACE_BLOODELF;
	g_SkillOwner[ULTIMATE_SLEEP		]	= RACE_BLOODELF;

	
	g_SkillOwner[SKILL_BERSERKING				]	= RACE_TROLL;
	g_SkillOwner[SKILL_REGENERATION		]	= RACE_TROLL;
	g_SkillOwner[SKILL_SHUFFLE		]	= RACE_TROLL;
	g_SkillOwner[ULTIMATE_STEALTH		]	= RACE_TROLL;
	
	g_SkillOwner[SKILL_SOUL				]	= RACE_WARLOCK;
	g_SkillOwner[SKILL_MAGIC		]	= RACE_WARLOCK;
	g_SkillOwner[SKILL_DRAIN		]	= RACE_WARLOCK;
	g_SkillOwner[ULTIMATE_ILUSION		]	= RACE_WARLOCK;
	g_SkillOwner[PASS_SEAL					]	= RACE_WARLOCK;
	
	g_SkillOwner[SKILL_ENERGY				]	= RACE_PRIEST;
	g_SkillOwner[SKILL_WORDS		]	= RACE_PRIEST;
	g_SkillOwner[SKILL_LIGHT		]	= RACE_PRIEST;
	g_SkillOwner[ULTIMATE_MIND		]	= RACE_PRIEST;
	g_SkillOwner[PASS_HEAVEN					]	= RACE_PRIEST;
	
		g_SkillOwner[SKILL_RAISE				]	= RACE_DEATH;
	g_SkillOwner[SKILL_PACT		]	= RACE_DEATH;
	g_SkillOwner[SKILL_POSESION		]	= RACE_DEATH;
	g_SkillOwner[ULTIMATE_SHADOW		]	= RACE_DEATH;
	g_SkillOwner[PASS_CONVERSION					]	= RACE_DEATH;
	
	g_SkillOwner[SKILL_WATER				]	= RACE_DRUID;
	g_SkillOwner[SKILL_TYPHOON		]	= RACE_DRUID;
	g_SkillOwner[SKILL_FIRE	]	= RACE_DRUID;
	g_SkillOwner[ULTIMATE_NATURA		]	= RACE_DRUID;
	g_SkillOwner[PASS_BALANCE					]	= RACE_DRUID;
	...
	g_SkillType[SKILL_SHADOW				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_HEROIC		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_ABUNDENCE		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_GIFT		]	= SKILL_TYPE_ULTIMATE;

	g_SkillType[SKILL_RUN				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_ABERRATION		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_FORM		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_CLAWS		]	= SKILL_TYPE_ULTIMATE;

	g_SkillType[SKILL_TORENT				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_AFFINITY		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_BLOODEYES		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_SLEEP		]	= SKILL_TYPE_ULTIMATE;

	
	g_SkillType[SKILL_BERSERKING				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_REGENERATION		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_SHUFFLE		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_STEALTH		]	= SKILL_TYPE_ULTIMATE;
	
	g_SkillType[SKILL_SOUL				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_MAGIC		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_DRAIN		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_ILUSION		]	= SKILL_TYPE_ULTIMATE;
	g_SkillType[PASS_SEAL					]	= SKILL_TYPE_PASSIVE;

	
	g_SkillType[SKILL_ENERGY				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_WORDS		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_LIGHT		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_MIND		]	= SKILL_TYPE_ULTIMATE;
	g_SkillType[PASS_HEAVEN					]	= SKILL_TYPE_PASSIVE;
	
	g_SkillType[SKILL_RAISE				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_PACT		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_POSESION		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_SHADOW		]	= SKILL_TYPE_ULTIMATE;
	g_SkillType[PASS_CONVERSION					]	= SKILL_TYPE_PASSIVE;
	
	
	g_SkillType[SKILL_WATER				]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_TYPHOON		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[SKILL_FIRE		]	= SKILL_TYPE_TRAINABLE;
	g_SkillType[ULTIMATE_NATURA		]	= SKILL_TYPE_ULTIMATE;
	g_SkillType[PASS_BALANCE					]	= SKILL_TYPE_PASSIVE;
	...
	g_SkillOrder[SKILL_SHADOW				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_HEROIC		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_ABUNDENCE		]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_GIFT		]	= SKILL_POS_4;

	g_SkillOrder[SKILL_RUN				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_ABERRATION		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_FORM		]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_CLAWS		]	= SKILL_POS_4;

	g_SkillOrder[SKILL_TORENT			]	= SKILL_POS_1;
	g_SkillOrder[SKILL_AFFINITY		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_BLOODEYES	]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_SLEEP		]	= SKILL_POS_4;

	g_SkillOrder[SKILL_BERSERKING			]	= SKILL_POS_1;
	g_SkillOrder[SKILL_REGENERATION		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_SHUFFLE	]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_STEALTH		]	= SKILL_POS_4;
	
	g_SkillOrder[SKILL_SOUL				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_MAGIC		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_DRAIN		]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_ILUSION		]	= SKILL_POS_4;
	g_SkillOrder[PASS_SEAL					]	= SKILL_POS_NONE;
	
	g_SkillOrder[SKILL_ENERGY				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_WORDS		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_LIGHT		]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_MIND		]	= SKILL_POS_4;
	g_SkillOrder[PASS_HEAVEN					]	= SKILL_POS_NONE;
	
	g_SkillOrder[SKILL_RAISE				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_PACT		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_POSESION		]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_SHADOW		]	= SKILL_POS_4;
	g_SkillOrder[PASS_CONVERSION					]	= SKILL_POS_NONE;
	
		g_SkillOrder[SKILL_WATER				]	= SKILL_POS_1;
	g_SkillOrder[SKILL_TYPHOON		]	= SKILL_POS_2;
	g_SkillOrder[SKILL_FIRE	]	= SKILL_POS_3;
	g_SkillOrder[ULTIMATE_NATURA		]	= SKILL_POS_4;
	g_SkillOrder[PASS_BALANCE					]	= SKILL_POS_NONE;
...
SM_SkillSet( id, iSkillID )
{
	switch( iSkillID )
	{
		...
		case SKILL_ABUNDENCE:				// Draenei Abundence
		{
			DR_Abundence( id )
		}

		
		case SKILL_REGENERATION:				// Troll Regeneration
		{
			 TR_Regeneration( id )
		}
		...
		case SKILL_SERPENTWARD:				// Shadow Hunter's Serpent Ward
		{
			...
			case SKILL_LIGHT:				// Priest Light Ward
		{
			PR_LightWard( id );
		}
		...
		case SKILL_MAGIC:					// Warlock Magic essence 
		{
			WK_Magic( id );
		}
		case SKILL_DRAIN:					// Warlock Drain Life 
		{
			WK_DrainLife( id );
		}
	}
