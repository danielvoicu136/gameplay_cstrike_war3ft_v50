...
new CVAR_wc3_shopmenu3_vip;
new CVAR_wc3_shopmenu4_vip;

// Race 

new CVAR_wc3_draenei_vip;
new CVAR_wc3_worgen_vip;
new CVAR_wc3_bloodelf_vip;
new CVAR_wc3_troll_vip;
new CVAR_wc3_warlock_vip;
new CVAR_wc3_priest_vip;
new CVAR_wc3_death_vip;
new CVAR_wc3_druid_vip;

// Gold Cvar

new CVAR_wc3_max_gold;
new CVAR_wc3_max_gold_vip;
...
public CVAR_Init()
{
	...
	CVAR_wc3_loot_items_health = register_cvar( "wc3_loot_items_health","20");
	CVAR_wc3_loot_items_armor = register_cvar( "wc3_loot_items_armor","30");
	CVAR_wc3_loot_remove = register_cvar( "wc3_loot_remove","1");
	CVAR_wc3_loot_stay = register_cvar( "wc3_loot_stay","10");

	// Cvar Shopmenu's
	
	CVAR_wc3_shopmenu3_vip = register_cvar( "wc3_shopmenu3_vip","1");
	CVAR_wc3_shopmenu4_vip = register_cvar( "wc3_shopmenu4_vip","1");
	
	CVAR_wc3_draenei_vip = register_cvar( "wc3_draenei_vip","1");
	CVAR_wc3_worgen_vip = register_cvar( "wc3_worgen_vip","1");
	CVAR_wc3_bloodelf_vip = register_cvar( "wc3_bloodelf_vip","1");
	CVAR_wc3_troll_vip = register_cvar( "wc3_troll_vip","1");
	CVAR_wc3_warlock_vip = register_cvar( "wc3_warlock_vip","1");
	CVAR_wc3_priest_vip = register_cvar( "wc3_priest_vip","1");
	CVAR_wc3_death_vip = register_cvar( "wc3_death_vip","1");
	CVAR_wc3_druid_vip = register_cvar( "wc3_druid_vip","1");
	
	CVAR_wc3_max_gold = register_cvar( "wc3_max_gold","20");
	CVAR_wc3_max_gold_vip = register_cvar( "wc3_max_gold_vip","25");
