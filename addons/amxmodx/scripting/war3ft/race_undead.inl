...
UD_Suicide( id )
{
	...
	if ( SM_GetSkillLevel( id, ULTIMATE_SUICIDE ) == 1 )
		{ ULT_ResetCooldown( id, 45 ); }	
		else if ( SM_GetSkillLevel( id, ULTIMATE_SUICIDE ) == 2 )
		{ ULT_ResetCooldown( id, 35 ); }
		else if ( SM_GetSkillLevel( id, ULTIMATE_SUICIDE ) == 3 )
		{ ULT_ResetCooldown( id, 25 ); }
		else if ( SM_GetSkillLevel( id, ULTIMATE_SUICIDE ) == 4 )
