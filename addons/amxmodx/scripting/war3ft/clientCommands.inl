...
public cmd_Ultimate(id)
{
	...
	switch ( iSkillID )
	{
		...
		{
			TR_Ult_StealthAura( id );
		}
		
		// Druid - Natura 
		case ULTIMATE_NATURA:
		{
			DU_ULT_Natura( id );
		}

			// WARLOCK - Decoy  
		case ULTIMATE_ILUSION:
		{
			ULT_make_decoy( id );
		}
...
CMD_Handle( id, szCmd[], bool:bThroughSay )
{
	...
	{
		ChatColor( id,"!gMove Speed:!t %0.0f", get_user_maxspeed( id ) );
	}
	...
	*/
	...
	{
		ChatColor( id,"!g[!t %s!g ] Ultimate Cooldowns - Global:%d  Player:%d", g_MODclient, g_iUltimateDelay, p_data[id][P_ULTIMATEDELAY] );
	}
	...
	else if ( CMD_Equal( id, szCmd, "levitation" ) )
	{
		...
		{
			ChatColor( id,"!g* [!t %s!g ] You do not have levitation !", g_MODclient );
		...
		if ( g_bLevitation[id] )
		{
			...
			ChatColor( id,"!g* [!t %s!g ] Levitation !tdisabled!g , type!t /levitation to re-enable", g_MODclient );
		}
		else
		{
			...
			ChatColor( id,"!g* [!t %s!g ] Levitation!t enabled!g , type!t /levitation to disable", g_MODclient );
		}
	...
	{
	ChatColor( id,"!g* [!t %s!g ]!t XP is saved automatically!g you don't need to type this command", g_MODclient );
	}
	...
	/*else if ( CMD_Equal( id,  szCmd, "daeva" ) || CMD_Equal( id,  szCmd, "daevax" ) || CMD_Equal( id,  szCmd, "mdx" ) || CMD_Equal( id,  szCmd, "onemdx" ) || CMD_Equal( id,  szCmd, "one" ) || CMD_Equal( id,  szCmd, "developer" ) )
	{
		WC3_CheckDev(id)
	}*/
	...
	else if ( get_pcvar_num( CVAR_wc3_cheats ) && ( CMD_Equal( id,  szCmd, "level10" ) || CMD_Equal( id,  szCmd, "lvl10" ) ) )
	{
		...
		if ( !g_bGivenLevel10[id][iRaceID] )
		{
			...
			ChatColor( id,"!g* [!t %s!g ] Ok cheater take!t level 10!g !", g_MODclient );
		}
		// We've already given them XP!!!
		else
		{	
			ChatColor( id,"!g* [!t %s!g ] Hey I've already given you level 10 for this race !", g_MODclient );
		}
	}
	...
	if ( get_pcvar_num( CVAR_wc3_races ) > 4 )
	{
		...
		else if ( CMD_Equal( id,  szCmd, "trade" ) || CMD_Equal( id,  szCmd, "trademenu" ))
		{
			menu_Trade_Options( id );
		}
		
		// Shopmenu3  ------------------------------------------------------------------
		
		if ( CMD_Equal( id,  szCmd, "itemsinfo3" ) )
		{
			MOTD_ItemsInfo( id, 18 );
		}
		else if ( CMD_Equal( id,  szCmd, "shopmenu3" ) )
		{	
...
{   
		...
		else if ( CMD_Equal( id, szCmd, "armor" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_FROSTARMOR ); }
		}

		else if ( CMD_Equal( id, szCmd, "grenade" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_GRENADE );}
		}

		else if ( CMD_Equal( id, szCmd, "mirror" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_MIRROR ); }
		}

		else if ( CMD_Equal( id, szCmd, "accelerator" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_ACCELERATOR );}
		}

		else if ( CMD_Equal( id, szCmd, "death" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_DEATH ); } 
		}
		
		
			else if ( CMD_Equal( id, szCmd, "healing" ) || CMD_Equal( id, szCmd, "potion" ))
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_POTION );}
		}

		else if ( CMD_Equal( id, szCmd, "scepter" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_SCEPTER );}
		}

		else if ( CMD_Equal( id, szCmd, "scanner" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
			...
			else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_SCANNER ); }
		}

		else if ( CMD_Equal( id, szCmd, "steel" ) )
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu3_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_STEEL); }
		}
		
		// Shopmenu4  ------------------------------------------------------------------
		
		if ( CMD_Equal( id,  szCmd, "itemsinfo4" ) )
		{
		
			MOTD_ItemsInfo( id, 27 );
		}
		else if ( CMD_Equal( id,  szCmd, "shopmenu4" ) )
...
{   
		...
		else if ( CMD_Equal( id, szCmd, "assasin" ) )
		{	if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_ASSASIN ); }
		}

		else if ( CMD_Equal( id, szCmd, "snake" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_SNAKE ); }
		}

		else if ( CMD_Equal( id, szCmd, "portal" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_PORTAL ); }
		}

		else if ( CMD_Equal( id, szCmd, "omniscience" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
			...
			else { if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_OMNISCIENCE ); }
		}

		else if ( CMD_Equal( id, szCmd, "infinity" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_INFINITY ); }
		}
		
		
			else if ( CMD_Equal( id, szCmd, "flame" ) || CMD_Equal( id, szCmd, "flames" ))
		{if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_FLAME ); }
		}

		else if ( CMD_Equal( id, szCmd, "skull" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_SKULL ); }
		}

		else if ( CMD_Equal( id, szCmd, "book" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
			...
			else {if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_BOOK );  }
		}

		else if ( CMD_Equal( id, szCmd, "spikes" ) )
		{ if(!(get_user_flags(id) & ADMIN_LEVEL_H) && get_pcvar_num(CVAR_wc3_shopmenu4_vip) == 1) 
{   
		...
		else {	if (ITEM_MenuCanBuyCheck(id)) ITEM_Buy( id, ITEM_SPIKES ); } 
		}
