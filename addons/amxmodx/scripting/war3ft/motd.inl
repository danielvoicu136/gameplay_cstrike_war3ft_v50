...
show_motd(id,"addons/amxmodx/configs/war3ft/vip.html");
return;
}

public MOTD_TRADEINFO( id )   //istart
{

	static szTmp[256], szTmp2[256], pos;
	pos = 0;
	...
	pos += formatex( szTmpMsg[pos], 2047-pos, "%s", MOTD_header );
		...
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 16000 $ for 1 Gold</li><div id='s'>Money 16000 $</div><br>", szTmp, szTmp2 );
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 1500 XP for 1 Gold</li><div id='s'>Experience 1500 XP</div><br>", szTmp, szTmp2 );
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 7500 XP for 5 Gold</li><div id='s'>Experience 7500 XP</div><br>", szTmp, szTmp2 );
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 1 Gold for 16000 $</li><div id='s'>1 Gold ( for $ )</div><br>", szTmp, szTmp2 );
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 1 Gold for 1500 XP</li><div id='s'>1 Gold ( for XP )</div><br>", szTmp, szTmp2 );
		pos += formatex( szTmpMsg[pos], 2047-pos, "<li>You will receive 5 Gold for 7500 XP</li><div id='s'>5 Gold ( for XP )</div><br>", szTmp, szTmp2 );
		
	
	
	
	
		formatex( szTmp, 127, "Trade Information");
